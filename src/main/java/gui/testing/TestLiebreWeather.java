...
public class TestLiebreWeather {
    ...
    public static void main(String[] args) {
        ...
        Source<String> source = query.addBaseSource("src1", () -> System.currentTimeMillis() + "," + CITIES[(int) (Math.random() * CITIES.length)] + "," +
    ...
    public static class WeatherData implements RichTuple {
