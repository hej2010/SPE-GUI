...
import se.chalmers.datx05.metrics.graphite.GraphiteRenderQuery;
import se.chalmers.datx05.metrics.graphite.RenderDatapoint;
import se.chalmers.datx05.utils.Time;
...
public class MetricsController {
    ...
    private void showGraph(LineChart<Number, Number> lineChart, GraphiteRenderQuery q) {
        ...
        chartPane.getStylesheets().add("se/chalmers/datx05/mixed-chart-sample.css");
